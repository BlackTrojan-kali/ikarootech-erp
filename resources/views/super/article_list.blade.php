...
<div class="p-8">
    ...
    <div class="w-full gap-4 flex justify-end mb-4">
        <button class="secondary text-white font-bold p-4 rounded-md "><a href="{{ route('addFamily') }}">Ajouter une
        Famille</a></button>

        <button class="secondary text-white font-bold p-4 rounded-md "><a href="{{ route('chooseArticleType') }}">Ajouter
                un Article</a></button>
    </div>
    ...
    <h1 class="text-xl font-bold text-center">Familles d'articles</h1>
    <br>
